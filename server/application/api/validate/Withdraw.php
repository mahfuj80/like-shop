...
class Withdraw extends Validate
{
    protected $rule = [
        ...
        'real_name' => 'requireIf:type,3|requireIf:type,4|requireIf:type,5',//真实姓名
    ...
    {
        $able_withdraw = Db::name('user')->where('id', $data['user_id'])->value('user_money');
