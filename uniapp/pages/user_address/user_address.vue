<template>
  ...
  <view class="user-address">
    <view class="no-address column-center" v-if="!hasAddress">
      ...
      ></image>
      <view class="sm muted">{{ $t("暂无添加地址，请添加") }}~</view>
    </view>
    ...
    >
      <view class="column-center tips-dialog">
        ...
        <view style="margin-top: 30rpx">{{ $t("确认删除该地址吗") }}？</view>
      </view>
    </u-modal>
    <view class="footer row-between fixed bg-white">
      <!-- #ifdef H5 || MP-WEIXIN -->
      <view
        class="btn row-center bg-gray br60 mr20"
      ...
      <!-- #endif -->
      <view
        class="btn bg-primary white md row-center br60"
        @click="addAddress"
        >{{ $t("新增收货地址") }}</view
      >
    </view>
