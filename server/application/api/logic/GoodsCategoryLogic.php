...
//            if(!isset($list1['sons'])){
            ...
            $lists[$key1]['type'] = 1;
            $lists[$key1]['name'] = lang($lists[$key1]['name']);
        }

        //pc端不显示品牌, FIXME: 不显示品牌
        if (1 == $client && false) {
        ...
        Cache::set('goods_category_' . $client, array_values($lists), 60);
