...
export function buyVip(data) {
    return request.post("vip/buyVip", data)
}
export function teamCount(params) {
    return request.get("team_list/teamCount", {params})
}
export function teamList(params) {
    return request.get("team_list/teamList", {params})
}
export function sendScoreToUid(data) {
    return request.post("vip/sendScoreToUid", data)
}
