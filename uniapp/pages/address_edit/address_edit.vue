    ...
    <form @submit="formSubmit" report-submit="true">
        <view class="form bg-white">
            <view class="form-item row">
                <view class="label">{{ $t('收货人') }}</view>
                <input class="ml10" v-model="addressObj.contact" name="contact" type="text" :placeholder=" $t('请填写收货人姓名') " />
            </view>
            <view class="form-item row">
                <view class="label">{{ $t('联系方式') }}</view>
                <input class="ml10" name="telephone" v-model="addressObj.telephone" type="number" :placeholder=" $t('请填写手机号码') "></input>
            </view>
            <!-- <view @click="showRegion = true">
                <view class="form-item row">
                    <view class="label">{{ $t('所在地区') }}</view>
        ...
        <button class="my-btn bg-primary white br60" form-type="submit">{{ $t('完成') }}</button>
    </form>
