      ...
      >
        ...
        >
          ...
          <view
            ...
            "
            :style="
              item.active == 1 ? 'background-color: #FF2C3C;color: white' : ''
            "
          >
            {{ $t(item.tips) }}
          </view>
    ...
    <view class="goods-list">
      ...
      >
        ...
        <view class="goods-info">
          <view style="width: 490rpx" class="goods-name line2 mb10">{{
            item.name
          }}</view>
      ...
      <loading-footer :status="loadingStatus" slotEmpty>
        <view class="data-null column-center" slot="empty">
          ...
          <view class="muted nr">{{ $t("暂无商品") }}～</view>
        </view>
      </loading-footer>
    </view>
    <float-tab></float-tab>
...
export default {
  ...
  methods: {
    ...
    getSeckillGoodsFun(id) {
      ...
      loadingFun(getSeckillGoods, page, seckillGoods, this.loadingStatus, {
        id: id,
      }).then((res) => {
        if (res) {
          this.page = res.page;
